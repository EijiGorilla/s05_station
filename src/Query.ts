...
export async function generateChartData(station: any) {
  ...
  const others_comp = rooms[1] + specialityEquipment[1] + mass[1];
  const others_incomp = rooms[0] + specialityEquipment[0] + mass[0];
  const others_delay = rooms[2] + specialityEquipment[2] + mass[2];
